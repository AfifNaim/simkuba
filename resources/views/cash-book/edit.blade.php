...
<form id="cashbook-form" action="{{ route('cash-books.update', $cashBook->id) }}" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
        @method('PUT')
        @csrf
        <input type="hidden" name="type" value="{{ $type }}">
        <input type="hidden" name="user_id" value="{{ $cashBook->user_id }}">
        <input type="hidden" name="company_id" value="{{ $cashBook->company_id }}">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <label>Tanggal</label>
                    <input type="date" class="form-control" name="date" value="{{ $cashBook->date }}">
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control" name="category_id" id="select-category" >
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ $cashBook->category_id == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="number" class="form-control" id="inlineFormInputGroup" name="amount" min="0" value="{{ $cashBook->amount }}" placeholder="Nominal">
                    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <label>Qty</label>
                    <input type="number" class="form-control" name="qty" min="1" value="{{ $cashBook->qty }}">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <label>Foto</label><br>
                    <image src="{{ asset('images/cashbook/'.$cashBook->image) }}" width="100%" alt="image" />
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <label>Catatan</label>
                    <textarea class="form-control" style="height: 70px;" name="description" >{{ $cashBook->description }}</textarea>
